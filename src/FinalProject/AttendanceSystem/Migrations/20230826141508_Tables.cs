        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClassEndDate = table.Column<DateTime>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseAttendances", x => new { x.CourseId, x.StudentId, x.AttendanceDate });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CourseAttendances_Users_StudentId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Salman Nur", "123456", "Admin", "admin" });
